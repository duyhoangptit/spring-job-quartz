...
public class CustomPayrollRetryPolicy implements RetryPolicy {
    ...
    private int currentRetryCount = 0; // Lưu ý: Nếu lưu biến này tại đây, Policy phải là PROTOTYPE (mỗi dòng dữ liệu/chunk dùng 1 instance mới) để tránh xung đột luồng
